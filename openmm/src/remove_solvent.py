...
traj_filename = f'struct{args.structid}/{args.pdbid}_struct{args.structid}.xtc'
top_filename = f'struct{args.structid}/{args.pdbid}_struct{args.structid}_sol.pdb'
...
no_sol.save_xtc(f'struct{args.structid}/{args.pdbid}_struct{args.structid}_nosol.xtc')
print("saved")
